...
class SubmodelTreeTestMultiDecisionID(unittest.TestCase):
    def setUp(self):
        self.file_name = os.path.join(os.path.join(BENCHMARK_DIR, "sysadmin_mdp"), "sysadmin_mdp_a_s=2_t=3")
    ...
    def test_submodel_tree_dec(self):
        st = submodel_tree_decomposition(self.dn)
