...
# runs but very slow!
def test_gdd_4():
    file_name = os.path.join(os.path.join(os.getcwd(), "test_data"), "mdp1-4_2_2_5.mixed")
    ...
    gdd.propagate_iter()
    bound = gdd.bounds()
    print("{}\tiw\t{}\ti\t1\tgdd:{}\t(opt 3.695057019)\t(JGDID i=1 4.366097966)".format(time()-t0, 15, bound))

    # 4.99 after 323 sec GMID
    # 4.31 after 2 hr GMID
